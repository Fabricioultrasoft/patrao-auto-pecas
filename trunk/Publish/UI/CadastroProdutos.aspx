...
&nbsp;&nbsp;<a href="#cadastrar" rel="modal">Cadastrar Novo Produto</a>
    <br />   
     ...
     <asp:ImageButton ID="imgBtnPesquisar" runat="server" Text="Pesquisar" onclick="imgBtnPesquisar_Click" ToolTip="Pesquisar" Width="30px" ImageUrl="~/Images/buscar.gif" />
    <br />   
     <br /> 
	...
	<h3>Cadastro de Produtos:</h3>
        ...
        <table>
             <tr>
                 <td>
                     <asp:Button ID="btnSalvar" runat="server" ToolTip ="Salvar" Text="Salvar"  OnClick="btnSalvar_Click" class="salvar" />
                     <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                         <ContentTemplate>
                            <asp:Button ID="btnSalvarContinuar" runat="server" ToolTip ="Salvar Continuar" Text="Salvar Continuar"  OnClick="btnSalvarContinuar_Click"  class="salvar"/>
                         </ContentTemplate>
                     </asp:UpdatePanel>   
                </td>
            </tr>
